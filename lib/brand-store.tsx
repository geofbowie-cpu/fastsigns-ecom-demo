...
export function buildBrand(overrides: BrandOverrides) {
  ...
  return {
    ...
    heroBgImage: overrides.heroBgImage ?? (base as any).heroBgImage ?? null,
    heroBgPosition: overrides.heroBgPosition ?? (base as any).heroBgPosition ?? { x: 50, y: 50 },
    heroBgZoom: overrides.heroBgZoom ?? (base as any).heroBgZoom ?? 1,
    heroBgOverlay: overrides.heroBgOverlay ?? (base as any).heroBgOverlay ?? 0.5,
